The file `data/experiments/conv_lstm/version_0/checkpoints/Epoch-epoch=58-ENS-EarthNetScore=0.3247.ckpt` contains the weights of the model that was used to produce most of the results from the paper:
